            ...
            >
              ...
              >
                <div className="relative">
                  <button
                    onClick={closeVideoModal}
                    className="absolute top-2 right-2 sm:top-4 sm:right-4 z-10 p-1.5 sm:p-2 rounded-full bg-black/20 text-white hover:bg-black/40 transition-colors duration-300"
                  >
