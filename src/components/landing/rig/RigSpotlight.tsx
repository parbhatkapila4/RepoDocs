...
const ORBITS = [
  {
    path: "M10,160 a150,25 0 1,0 300,0 a150,25 0 1,0 -300,0",
    dur: 16,
    color: GREEN,
    r: 2,
    opacity: 0.8,
  ...
  {
    path: "M80,160 a80,150 0 1,0 160,0 a80,150 0 1,0 -160,0",
    dur: 26,
    color: PAPER,
    r: 1.8,
    opacity: 0.45,
  ...
  {
    path: "M10,160 a150,150 0 1,0 300,0 a150,150 0 1,0 -300,0",
    dur: 34,
    color: PAPER,
    r: 1.6,
    opacity: 0.35,
...
function FlowCard({
  ...
  return (
    <div
      className={`border px-5 py-2.5 text-center font-mono text-[11px] uppercase tracking-[0.16em] ${
        highlighted ? "rig-core-glow border-white/25" : "border-white/[0.12]"
      }`}
          ...
          <div className="grid lg:grid-cols-2">
            ...
            >
              ...
              <style>{`
                ...
                @media (prefers-reduced-motion: reduce) {
                  .rig-packet, .rig-core-glow, .rig-mapped { animation: none; }
                }
              `}</style>
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <FlowCard dim>Scattered files</FlowCard>
                <Connector label="indexed" reduced={reduced} />
                <FlowCard highlighted accent="MAPPED">
                  RepoDoc
                </FlowCard>
                <Connector label="linked" delay={1.2} reduced={reduced} />
            ...
            >
              ...
              <p className="mt-5 max-w-md text-[15px] leading-[1.6] text-white/55">
                ...
                directions, read straight out of the source - so you start from
                the shape of the repo instead of a folder tree.
              </p>
            </div>
          </div>
