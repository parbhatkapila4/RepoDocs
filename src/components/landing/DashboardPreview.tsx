      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/70 max-w-2xl mx-auto">
            Manage all your generated docs in one place with powerful sharing
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-3 glass-card rounded-lg border-subtle gap-3 sm:gap-0">
                  <div className="flex items-center space-x-3 sm:space-x-3">
                    <div className="w-12 h-12 sm:w-8 sm:h-8 bg-white/10 rounded-full flex items-center justify-center border border-subtle glow-subtle shrink-0">
                      <span className="text-white text-base sm:text-sm font-bold">
                        R
                      </span>
                    </div>
                    <div className="min-w-0 flex-1">
                      <p className="font-medium text-white text-base sm:text-base">
                        react-dashboard
                      </p>
                      <p className="text-sm sm:text-sm text-white/60">
                  ...
                  <div className="flex space-x-2">
                    <Button
                      size="sm"
                      variant="outline"
                      className="glass-card border-subtle text-white/70 hover:text-white hover:bg-white/5 w-10 h-10 sm:w-auto sm:h-auto"
                    >
              ...
              <div className="space-y-4">
                <div className="p-5 sm:p-4 glass-card border-subtle rounded-lg">
                  <div className="flex items-center justify-between mb-3 sm:mb-2">
                    <h4 className="font-medium text-white text-base sm:text-base">
                      react-dashboard docs
                    </h4>
                    <Badge
                      variant="secondary"
                      className="glass-card border-subtle text-white/80 text-xs sm:text-xs px-2 py-1"
                    >
                      Public
                    </Badge>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <Button
                      size="sm"
                      variant="outline"
                      className="glass-card border-subtle text-white/70 hover:text-white hover:bg-white/5 w-full sm:w-auto"
                    >
