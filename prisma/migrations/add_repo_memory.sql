CREATE TABLE IF NOT EXISTS "RepoMemory" (
  ...
  CONSTRAINT "RepoMemory_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE INDEX IF NOT EXISTS "idx_repoMemory_embedding_hnsw" ON "RepoMemory" USING hnsw ("embedding" vector_cosine_ops);