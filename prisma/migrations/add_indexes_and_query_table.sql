...
CREATE INDEX IF NOT EXISTS "idx_sourceCodeEmbeddings_embedding_hnsw" ON "SourceCodeEmbiddings" USING hnsw ("summaryEmbedding" vector_cosine_ops);
...
CREATE TABLE IF NOT EXISTS "CodebaseQueries" (
  ...
  CONSTRAINT "CodebaseQueries_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE INDEX IF NOT EXISTS "idx_codebaseQueries_projectId_createdAt" ON "CodebaseQueries"("projectId", "createdAt" DESC);
