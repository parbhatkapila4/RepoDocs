...
describe('ChatPage', () => {
  ...
  it('renders chat interface correctly', () => {
    ...
    expect(screen.getByPlaceholderText('Ask a question about your codebase...')).toBeInTheDocument();
  });
  ...
  it('shows suggested questions when no messages', () => {
    ...
    expect(screen.getByText('How does authentication work in this project?')).toBeInTheDocument();
  });
  ...
  it('handles message submission correctly', async () => {
    ...
    const input = screen.getByPlaceholderText('Ask a question about your codebase...');
  ...
  it('shows loading state during API call', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Searching codebase and generating response...')).toBeInTheDocument();
    });
  });
